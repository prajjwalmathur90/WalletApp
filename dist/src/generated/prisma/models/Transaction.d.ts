...
export type TransactionOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "from_user" | "to_user" | "amount" | "status" | "idempotency_key" | "createdAt", ExtArgs["result"]["transaction"]>;
